"""Recreate the 08b 12m-selection runs against the FIXED cache.

Reads the same grid as run_grid_search_core_2015_2020.py (baseline/core, 2m sel,
pct_per_pair=0.045, max_pairs=20) and runs each config into a CLEAN output dir.
The huck-shadow bug is fixed in run_backtest_parallel.py, so folds now hit the
pair_selection_cache instead of the 12-month sp500 huck pool.
"""
...
END = '2021-01-01'
BASE_DIR = 'diagnosis/08a_core_2015_2020'
