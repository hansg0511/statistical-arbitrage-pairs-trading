"""Run the 12-month selection grid on SP500, 2015-2020.

Mirrors run_recreate_08_clean.py but with --sel_months 12 so each fold's pair
selection comes from the 12m SP500 pool (sp500_12m.pkl, routed automatically
by selection window: masked to sp500, filtered p<0.05 log). Same-sector configs
apply the real sector mask; cross configs keep --return_divergence 0.10 (they
are NOT collapsed into same-sector; the divergence flag is a real runtime
filter). The cache-shadow bug / --repro_contam flag is removed.
"""
import subprocess, json, os, sys, statistics, threading
from concurrent.futures import ThreadPoolExecutor, as_completed
from run_full_results import fold_stats

START_DATES = ['2015-01-01', '2017-01-01', '2019-01-01']
END = '2021-01-01'
BASE_DIR = 'diagnosis/09b_sp500_12m_sel_2015_2020'
