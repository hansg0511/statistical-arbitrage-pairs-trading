"""Run the 12-month selection grid on the CORE universe, 2023-2025 (10a).

Core universe + 12-month selection from the SP500 superset pool
(sp500_12m.pkl), sector mask applied. Uses the 2023-2025 period with monthly
start dates so each fold's pair selection is 12-month core-masked.
"""
...
END = '2026-01-01'
BASE_DIR = 'diagnosis/10a_core_12m_sel_2023_2025'
