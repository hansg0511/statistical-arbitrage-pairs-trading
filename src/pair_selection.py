...
class PairSelector:
    ...
    def analyze_pair(stock1: pd.Series, stock2: pd.Series) -> Dict[str, float]:
        ...
        return {
            ...
            'hedge_ratio_log': model_log.params.iloc[1],
            'intercept_log': model_log.params.iloc[0],
            ...
            'hedge_ratio_norm': model_norm.params.iloc[1],
            'intercept_norm': model_norm.params.iloc[0],
